LANGUAGE_NAME := tree-sitter-atob
HOMEPAGE_URL := https://github.com/futarimiti/tree-sitter-atob
VERSION := 0.0.1
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/atob '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/atob
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/atob
